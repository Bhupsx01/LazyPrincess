...
API_ID = int(environ.get('API_ID', '10917004'))
API_HASH = environ.get('API_HASH', '19292d2f624654ef44989e7fba9736ab')
BOT_TOKEN = environ.get('BOT_TOKEN', "6222728330:AAES8rG2Va0FQPqLoPK6ybGdO0Q_DXJlwN8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1685321760').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001844536237').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1685321760').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001814642372')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "const { MongoClient, ServerApiVersion } = require('mongodb');
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001713083070'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'OmfooMoviesNetwork')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [OMf](https://t.me/OmfooMoviesNetwork)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [OMF](https://t.me/OmfooMoviesNetwork)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡<b>File uploaded by [Omf](https://t.me/OmfooMoviesNetwork)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [OMF](https://t.me/OmfooMoviesNetwork)</b> ↭  🔥")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'Z1kBg3tadSRJxpAJTsk4X5D5XOu1')
...
DOWNLOAD_TEXT_URL = "https://t.me/OmfooMoviesNetwork"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/OmfooMoviesNetwork"
